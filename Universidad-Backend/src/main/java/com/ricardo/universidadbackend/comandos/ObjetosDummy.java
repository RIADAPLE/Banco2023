...
public class ObjetosDummy {
    public static Aula getAula123(){
        return new Aula(null, 123,"24 x 36",3, Pizarron.PIZARRA_BLANCA);
    }
    ...
    public static Pabellon getPabellonUno(){
        return new Pabellon(null, 450.5, "Pabellon Uno", new Direccion("Calle uno", "1454", "1623", "", "", "Rodriguez Peña"));
    }
    ...
    public static Persona getProfesorUno(){
        return new Profesor(null, "Horacio", "Laurin", "22695142", new Direccion(),
                new BigDecimal("25600"));
    }

    public static Persona getProfesorDos(){
        return new Profesor(null, "Ruben", "Gonzalez", "25943608",new Direccion(), new BigDecimal("25600"));
    }
